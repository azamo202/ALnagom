...
<section class="container mx-auto px-4 py-12">
    <div class="flex justify-between items-center mb-8">
        <h2 class="text-3xl font-bold text-gray-800">كوش الأفراح</h2>
        <a href="#" class="text-orange-600 hover:text-orange-700 font-medium">عرض الكل</a>
    </div>
                ...
                <a href="{{ route('products', ['id' => $product->id]) }}" class="block">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between mt-2">
                            <span class="text-lg font-bold text-orange-600">{{ number_format($product->price, 2) }} ر.س</span>
                            <a href="{{ route('booking.form', ['productId' => $product->id]) }}"
                               class="bg-orange-500 hover:bg-orange-600 text-white px-3 py-1 rounded text-sm inline-block text-center">
...
<section class="container mx-auto px-4 py-12">
    <div class="flex justify-between items-center mb-8">
        <h2 class="text-3xl font-bold text-gray-800">كوش الأعراس</h2>
        <a href="#" class="text-orange-600 hover:text-orange-700 font-medium">عرض الكل</a>
    </div>
